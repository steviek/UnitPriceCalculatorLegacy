 ...
 * {@link #removeDragView(android.view.View)}. <p/> Currently, no error-checking is done on standard
 * {@link #addView(android.view.View)} and {@link #removeView(android.view.View)} calls, so avoid
 * using these with children previously declared as draggable to prevent memory leaks and/or subtle
 * bugs. Pull requests welcome!
 */
public class DragLinearLayout extends LinearLayout {
    ...
    /**
     * Use with {@link DragLinearLayout#setOnViewSwapListener(OnViewSwapListener)} to listen for
     * draggable view swaps.
     */
    public interface OnViewSwapListener {
        /**
         * Invoked right before the two items are swapped due to a drag event. After the swap, the
         * firstView will be in the secondPosition, and vice versa. <p/> No guarantee is made as to
         * which of the two has a lesser/greater position.
         */
    ...
    /**
     * Holds state information about the currently dragged item. <p/> Rough lifecycle:
     * <li>#startDetectingOnPossibleDrag - #detecting == true</li> <li>     if drag is recognised,
     * #onDragStart - #dragging == true</li> <li>     if drag ends, #onDragStop - #dragging ==
     * false, #settling == true</li> <li>if gesture ends without drag, or settling finishes,
     * #stopDetecting - #detecting == false</li>
     */
    ...
    public DragLinearLayout(Context context, AttributeSet attrs) {
        ...
        maxElevation = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 8, context.getResources().getDisplayMetrics());
    ...
    /**
     * Calls {@link #addView(android.view.View)} followed by {@link #setViewDraggable(android.view.View,
     * android.view.View)}.
     */
     ...
     * android.widget.ScrollView}, if one is registered via {@link #setContainerScrollView(android.widget.ScrollView)},
     * is scrolled.
     */
    @SuppressWarnings("UnusedDeclaration")
    ...
    private void onDragStop() {
        ...
        draggedItem.settleAnimation.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                if (Build.VERSION.SDK_INT >= 21 && draggedItem.view != null) {
                    draggedItem.view.setElevation((1 - animation.getAnimatedFraction()) * maxElevation);
                } else {
        ...
        draggedItem.settleAnimation.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (Build.VERSION.SDK_INT >= 21 && draggedItem.view != null) {
                    draggedItem.view.setElevation(maxElevation);
                } else {
