...
public enum DefaultUnit implements Unit {
  ...
  STONE(R.string.stone_symbol, 6350.293, System.IMPERIAL, UnitType.WEIGHT),
  ...
  KILOMETRE(R.string.kilometre_symbol, 1000, System.METRIC, UnitType.LENGTH),
  ...
  MILE(R.string.mile_symbol, 1609.34, System.IMPERIAL, UnitType.LENGTH),
  SQUARE_METRE(R.string.square_metre_symbol, 1, System.METRIC, UnitType.AREA),
  SQUARE_CENTIMETRE(R.string.square_centimetre_symbol, 0.0001, System.METRIC, UnitType.AREA),
  SQUARE_MILLIMETRE(R.string.square_millimetre_symbol, 0.000001, System.METRIC, UnitType.AREA),
  SQUARE_KILOMETRE(R.string.square_kilometre_symbol, 1000000, System.METRIC, UnitType.AREA),
  ARE(R.string.are_symbol, 100, System.METRIC, UnitType.AREA),
  HECTARE(R.string.hectare_symbol, 10000, System.METRIC, UnitType.AREA),
  ACRE(R.string.acre_symbol, 4046.856, System.IMPERIAL, UnitType.AREA),
  SQUARE_FOOT(R.string.square_foot_symbol, 0.092903, System.IMPERIAL, UnitType.AREA),
  SQUARE_INCH(R.string.square_inch_symbol, 0.00064516, System.IMPERIAL, UnitType.AREA),
  SQUARE_YARD(R.string.square_yard_symbol, 0.836127, System.IMPERIAL, UnitType.AREA),
